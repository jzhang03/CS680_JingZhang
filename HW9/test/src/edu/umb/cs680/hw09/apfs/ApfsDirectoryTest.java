...
public class ApfsDirectoryTest {
    ...
    public void verifyDirectoryEqualityRoot() {
        String[] expected = {"true", "root", Date1.toString(), "owner", "2", "23", "false", 
        		Date2.toString()};
    ...
    public void verifyDirectoryEqualityHome() {
        String[] expected = {"true", "Home", Date1.toString(), "owner", "4", "20", "false",
        		Date2.toString()};
    ...
    public void verifyDirectoryEqualityCode() {
        String[] expected = {"true", "Code", Date1.toString(), "owner", "3", "12", "false", 
        		Date2.toString()};
