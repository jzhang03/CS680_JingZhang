...
public class DirectoryTest {
    ...
    static Link x = new Link(null, "x", 1, Date, null);
    static Link y = new Link(null, "y", 1, Date, null);
    ...
    private String[] dirToStringArray(Directory d) {
        ...
        String[] dirInfo = {String.valueOf(d.isDirectory()), d.getName(), 
                ...
                String.valueOf(d.isFile()), String.valueOf(d.isLink())};
        return dirInfo;
    }
    ...
    public void verifyDirectoryEqualityRoot() {
        String[] expected = {"true", "Root", "0", Date.toString(), null, "2", "23", "false", 
        		"false"};
    ...
    public void verifyDirectoryEqualityHome() {
        String[] expected = {"true", "Home", "0", Date.toString(), "Root", "4", "20", "false", 
        		"false"};
    ...
    public void verifyDirectoryEqualityCode() {
        String[] expected = {"true", "Code", "0", Date.toString(), "Home", "3", "12", "false", 
        		 "false"};
