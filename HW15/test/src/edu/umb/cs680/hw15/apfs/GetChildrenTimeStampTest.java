...
public class GetChildrenTimeStampTest {
	...
	@Test
	public void verifyChildrenEquality() {
        ApfsDirectory rootDir = root;
        LinkedList<ApfsElement> actual = rootDir.getChildren((ApfsElement apfstest1, ApfsElement apfstest2) -> {
        	return apfstest2.getModifiedTimestamp().compareTo(apfstest1.getModifiedTimestamp());});
	...
	public void verifyFilesEquality() {
        ...
        LinkedList<ApfsFile> actual = homeDir.getFiles((ApfsElement apfstest1, ApfsElement apfstest2) -> {
        	return apfstest2.getModifiedTimestamp().compareTo(apfstest1.getModifiedTimestamp());});
	...
	public void verifyOrderEquality() {
		...
		LinkedList<ApfsElement> children = home.getChildren((ApfsElement apfstest1, ApfsElement apfstest2) -> 
		apfstest2.getModifiedTimestamp().compareTo(apfstest1.getModifiedTimestamp()));
